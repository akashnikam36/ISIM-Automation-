...
public class ProvisioningPolicy extends GenericWSClient{
	...
	public void CREATEPOLICY(String policyName,String roleName,String ServiceName) throws WSLoginServiceException, Exception{
		...
		if (lstWSOrganizationContainers != null
			...
			WSProvisioningPolicy policy = this.getProvisioningPolicy(policyName,ServiceName,roleName);
	...
	//--------------------------------------------------------------------------------------------------------------
	WSProvisioningPolicy getProvisioningPolicy(String policyName,String ServiceName,String roleName) throws Exception {
...
//		serviceTarget.setName("WinLocalProfile");
		...
		String serviceDN=properties.getProperty(ServiceName);
		System.out.println("Service Name:"+ServiceName);
		System.out.println("Service DN:"+serviceDN);
		serviceTarget.setName(serviceDN);
		...
		//if(rolename==true){
			...
			String roleDN=properties.getProperty(roleName);
			System.out.println("ROLE DN:"+roleDN);
			membership.setName(roleDN);
	...
	//-----------------------------------------------------------------------------------------------------
	public void mainMethodPolicy() throws WSLoginServiceException, Exception{
		...
		int len=policyNames.length;
		for(int i=0;i<len;i++){
			policy.CREATEPOLICY(policyNames[i],roleMember[i],serviceName[i]);
		}
